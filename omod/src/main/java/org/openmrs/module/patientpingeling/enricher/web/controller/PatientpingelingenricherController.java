 ...
 */
package org.openmrs.module.patientpingeling.enricher.web.controller;
 ...
 */
@Controller("${rootrootArtifactid}.PatientpingelingenricherController")
@RequestMapping(value = "module/${rootArtifactid}/${rootArtifactid}.form")
public class PatientpingelingenricherController {
